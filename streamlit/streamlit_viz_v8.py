...
#FIXME: Exception: Unexpected error in evaluation process: list index out of range
    ...
    if user_input:
        ...
        if st.session_state.turn==0:
            ...
            classify_candidate_dialogue_response=run_async(async_classify_candidate_dialogue(st.session_state.initial_question,user_input,st.session_state.interim_chat_history))
            ...
            if class_label != 'technical' and class_label != 'clarification(specific)':
                ...
                bot_dialogue_generator_response=run_async(async_generate_dialogue(class_label,st.session_state.interim_chat_history,user_input, st.session_state.initial_question,st.session_state.hint_count,st.session_state.assessment_payload,None,None))
                ...
                bot_dialogue_generator_response=run_async(async_generate_dialogue(candidate_answer_label,st.session_state.interim_chat_history,user_input, st.session_state.initial_question,st.session_state.hint_count,st.session_state.assessment_payload,st.session_state.meta_payload.question,candidate_answer_classification_rationale))
                print(f"BOT DIALOGUE LLM CONTENT BEFORE BREAKPOINT : {bot_dialogue_generator_response}")
                bot_dialogue_generator_content=json.loads(bot_dialogue_generator_response.content)
                bot_dialogue=bot_dialogue_generator_content[1]
                bot_dialogue_rationale=bot_dialogue_generator_content[2]
            ...
            if class_label != 'technical' and class_label != 'clarification(specific)':
                ...
                bot_dialogue_generator_response=run_async(async_generate_dialogue(class_label,st.session_state.interim_chat_history,user_input, st.session_state.initial_question,st.session_state.hint_count,st.session_state.assessment_payload,st.session_state.meta_payload.question,None))
                print(f"BOT DIALOGUE LLM CONTENT BEFORE BREAKPOINT : {bot_dialogue_generator_response}")
                bot_dialogue_generator_content=json.loads(bot_dialogue_generator_response.content)
                bot_dialogue=bot_dialogue_generator_content[1]
                bot_dialogue_rationale=bot_dialogue_generator_content[2]
