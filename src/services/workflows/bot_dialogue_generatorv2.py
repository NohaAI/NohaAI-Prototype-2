...
async def generate_dialogue(class_label, distilled_chat_history, candidate_dialogue, question, answer_evaluation=None,  bot_dialogue=None, rationale=None):
   ...
   #writing to rationale_logs.txt
    ...
    bot_dialogue_generator_response=await bot_dialogue_prompt_chain.ainvoke({'class': class_label, 'tech_question': question, 'bot_dialogue':  bot_dialogue, 'candidate_dialogue': candidate_dialogue,'chat_history' : distilled_chat_history, 'rationale': rationale, 'answer_evaluation' : answer_evaluation})
    ...
    return bot_dialogue, bot_dialogue_rationale, bot_dialogue_subcriterion, next_action
