...
async def classify_candidate_dialogue(bot_dialogue, candidate_dialogue,interim_chat_history):
    ...
    candidate_dialogue_label=await classify_candidate_dialogue_chain.ainvoke({'question': bot_dialogue,'answer': candidate_dialogue, 'interim_chat_history': interim_chat_history })
