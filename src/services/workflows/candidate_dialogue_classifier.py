...
async def classify_candidate_dialogue(bot_dialogue, candidate_dialogue,chat_history):
    ...
    candidate_dialogue_label=await classify_candidate_dialogue_chain.ainvoke({'bot_dialogue': bot_dialogue,'candidate_dialogue': candidate_dialogue, 'chat_history': chat_history })
